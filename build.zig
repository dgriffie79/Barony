...
pub fn build(b: *std.Build) void {
    ...
    const cpp_sources = &.{
        ...
        "src/objects.cpp", "src/files.cpp", "src/items.cpp",
        "src/paths.cpp", "src/charclass.cpp", "src/net.cpp", "src/game.cpp",
        "src/stat.cpp", "src/actplayer.cpp", "src/actmonster.cpp",
        "src/actitem.cpp", "src/acthudweapon.cpp", "src/actgib.cpp",
        ...
        "src/actfountain.cpp", "src/actsink.cpp",
        ...
        "src/shops.cpp", "src/mechanisms.cpp", "src/actchest.cpp",
        "src/actsprite.cpp", "src/menu.cpp", "src/actarrow.cpp",
        "src/actboulder.cpp",
        "src/actthrown.cpp", "src/actbeartrap.cpp",
        "src/book.cpp", "src/init_game.cpp",
        "src/scores.cpp", "src/achievements.cpp", "src/player.cpp",
        "src/entity_shared.cpp", "src/stat_shared.cpp", "src/item_tool.cpp",
        "src/actsummontrap.cpp", "src/monster_shared.cpp",
        "src/actpedestal.cpp", "src/actmagictrap.cpp",
