...
void actTorch(struct Entity* my);
void actCrystalShard(struct Entity* my);
void actLightSource(struct Entity* my);
void actSpearTrap(struct Entity* my);
void actGoldBag(struct Entity* my);
...
struct Item* entityNewItemWrap(int type, int status, Sint16 beatitude, Sint16 count, Uint32 appearance, bool identified);
struct Item* entityItemPickup(int player, struct Item* item);
struct Entity* entityDropItemMonsterWrap(struct Item* item, struct Entity* monster, struct Stat* monsterStats);
struct light_t* entityLightSphereShadowWrap(Sint32 x, Sint32 y, Sint32 radius, float r, float g, float b);
int entityGetMapHeight(void);
struct Entity* entityGetPlayerEntity(int player);
bool entityTorchTrySalvage(int player, struct Item* item);
void entityCompendiumTorchEvent(int player, int itemType);
void entityRemoveLightNode(struct Entity* my);
list_t* entityGetMapCreatures(void);
void entityStopSound(struct Entity* my);
void entitySpawnGib(struct Entity* entity);
void entitySetObituary(struct Entity* entity, const char* obituary);
int entityGetEntityBonusTrapResist(struct Entity* entity);
bool entityOnEntityTrapHitSacredPath(struct Entity* entity, struct Entity* trap);
struct Entity* entityMonsterAllyGetPlayerLeader(struct Entity* entity);
void entityAttack(struct Entity* entity, int pose, int charge, struct Entity* target);
void entityModHP(struct Entity* e, int amount);
bool entityIsActPlayer(struct Entity* e);
bool entityIsActMonster(struct Entity* e);
void entityMessagePlayerColor(int player, unsigned int type, unsigned int color, const char* msg);
bool entityPlayerIsLocalPlayer(int player);
void entityCameraShakeAdd(int player, double shakex, double shakey);
bool entityChallengeRunStrongTrapsActive(void);
void entityEventUpdateWorldTrapDamage(int player, const char* trapType, int damage);
void entityEventUpdateWorldTrapKilledBy(int player, const char* trapType, int count);
void entityEventUpdateWorldTrapFollowersKilled(int player, const char* trapType, int count);
void entitySendShakePacket(int player, unsigned char shakex_byte, unsigned char shakey_byte);
void actCampfire(Entity* my);
void actCauldron(Entity* my);
void actWorkbench(Entity* my);
void actMailbox(Entity* my);
unsigned int entityAchievementObserverGetUid(int playernum);
void entityCauldronCloseMenu(int playernum);
void entityCauldronOpenGUI(int playernum, Entity* my);
void entityWorkbenchCloseMenu(int playernum);
void entityWorkbenchOpenGUI(int playernum, Entity* my);
void entityMailboxCloseMenu(int playernum);
void entityMailboxOpenGUI(int playernum, Entity* my);
void entitySendPacketCauldronClose(unsigned int uid, int playernum);
void entitySendPacketCauldronOpen(unsigned int uid, int playernum);
void entitySendPacketWorkbenchClose(unsigned int uid, int playernum);
void entitySendPacketWorkbenchOpen(unsigned int uid, int playernum);
void entitySendPacketMailboxClose(unsigned int uid, int playernum);
void entitySendPacketMailboxOpen(unsigned int uid, int playernum);
void actArrowTrap(Entity* my);
struct Entity* entityNewEntity(Sint32 sprite, Uint32 pos, list_t* entlist, list_t* creaturelist);
void entitySetBehaviorArrow(struct Entity* entity);
struct Entity* entityDropItemMonsterWrapCount(struct Item* item, struct Entity* monster, struct Stat* monsterStats, Sint16 count);
void entityEventUpdateWorldArrowPilfered(int playernum, Sint32 qty);
#ifdef __cplusplus
}
#endif
...
void entityMapSetTile(int index, Sint32 value);
void entityServerUpdateEntityFlag(Entity* entity, int flag);
Item* entityNewItemWrap(int type, int status, Sint16 beatitude, Sint16 count, Uint32 appearance, bool identified);
Item* entityItemPickup(int player, Item* item);
Entity* entityDropItemMonsterWrap(Item* item, Entity* monster, Stat* monsterStats);
light_t* entityLightSphereShadowWrap(Sint32 x, Sint32 y, Sint32 radius, float r, float g, float b);
int entityGetMapHeight(void);
Entity* entityGetPlayerEntity(int player);
bool entityTorchTrySalvage(int player, Item* item);
void entityCompendiumTorchEvent(int player, int itemType);
void entityRemoveLightNode(Entity* my);
list_t* entityGetMapCreatures(void);
void entityStopSound(Entity* my);
void entitySpawnGib(Entity* entity);
void entitySetObituary(Entity* entity, const char* obituary);
int entityGetEntityBonusTrapResist(Entity* entity);
bool entityOnEntityTrapHitSacredPath(Entity* entity, Entity* trap);
Entity* entityMonsterAllyGetPlayerLeader(Entity* entity);
void entityAttack(Entity* entity, int pose, int charge, Entity* target);
void entityMessagePlayerColor(int player, Uint32 type, Uint32 color, const char* msg);
bool entityPlayerIsLocalPlayer(int player);
void entityCameraShakeAdd(int player, double shakex, double shakey);
bool entityChallengeRunStrongTrapsActive(void);
void entityEventUpdateWorldTrapDamage(int player, const char* trapType, int damage);
void entityEventUpdateWorldTrapKilledBy(int player, const char* trapType, int count);
void entityEventUpdateWorldTrapFollowersKilled(int player, const char* trapType, int count);
void entitySendShakePacket(int player, Uint8 shakex_byte, Uint8 shakey_byte);
void entityHeadstoneCreateDialogue(int player, Entity* my, int msgIndex);
bool entityHeadstoneMessageColor(int player, Uint32 type, Uint32 color, const char* msg);
...
bool entityIsActPlayer(Entity* e);
bool entityIsActMonster(Entity* e);
...
/* -- Power crystal bridge methods -- */
Entity* entitySpawnAmbientParticles(Entity* my, int chance, int particleSprite, int duration, double particleScale, bool shrink);
void tileEntityListAddEntity(Entity* entity);
void entityUpdateCircuitNeighbors(Entity* my);
void entityActCircuit(Entity* my);
...
/* -- Gold act bridges -- */
bool entityIsBlind(Entity* e);
bool entityGoldPickupForPlayer(Entity* my, int i);
void entitySteamAchievementClient(int player, const char* name);
const char* entityGetMapName(void);
bool entityIsPlayerGnome(int player);

/* -- Campfire/cauldron/workbench/mailbox bridges -- */
Uint32 entityAchievementObserverGetUid(int playernum);
void entityCauldronCloseMenu(int playernum);
void entityCauldronOpenGUI(int playernum, Entity* my);
void entityWorkbenchCloseMenu(int playernum);
void entityWorkbenchOpenGUI(int playernum, Entity* my);
void entityMailboxCloseMenu(int playernum);
void entityMailboxOpenGUI(int playernum, Entity* my);
void entitySendPacketCauldronClose(Uint32 uid, int playernum);
void entitySendPacketCauldronOpen(Uint32 uid, int playernum);
void entitySendPacketWorkbenchClose(Uint32 uid, int playernum);
void entitySendPacketWorkbenchOpen(Uint32 uid, int playernum);
void entitySendPacketMailboxClose(Uint32 uid, int playernum);
void entitySendPacketMailboxOpen(Uint32 uid, int playernum);

/* -- Arrow trap bridges -- */
void actArrowTrap(Entity* my);
Entity* entityNewEntity(Sint32 sprite, Uint32 pos, list_t* entlist, list_t* creaturelist);
void entitySetBehaviorArrow(Entity* entity);
Entity* entityDropItemMonsterWrapCount(Item* item, Entity* monster, Stat* monsterStats, Sint16 count);
void entityEventUpdateWorldArrowPilfered(int playernum, Sint32 qty);
